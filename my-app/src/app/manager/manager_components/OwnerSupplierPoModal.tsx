...
// DATA FLOW: OwnerInventoryTable / inventory/page.tsx → OwnerSupplierPoModal → window.print()
...
interface OwnerSupplierPoModalProps {
  isOpen: boolean;
...
export function OwnerSupplierPoModal({
  isOpen,
  lowStockItems,
  onClose,
}: OwnerSupplierPoModalProps) {
