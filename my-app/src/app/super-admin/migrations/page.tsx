  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-[14px] text-secondary mt-1">Track schema rollouts across tenant databases.</p>
      </div>
      
      <div className="bg-card border border-border rounded-lg p-8 flex items-center justify-center">
        <p className="text-secondary text-[14px]">Database migrations tracker coming soon.</p>
      </div>
    </div>
  );
}
