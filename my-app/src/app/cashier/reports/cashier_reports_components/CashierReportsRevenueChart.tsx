...
// DATA FLOW: useCashierReports → cashier_reports/page.tsx → CashierReportsRevenueChart → ApexCharts → UI

import dynamic from "next/dynamic";
import type { CashierReportsRevenueChartProps } from "@/app/cashier/reports/cashier_reports_types/CashierReportsTypes";
 ...
 *
 * @param dailyRevenue - Array of 30 CashierReportsDailyStat entries from useCashierReports
 */
export function CashierReportsRevenueChart({ dailyRevenue }: CashierReportsRevenueChartProps) {
