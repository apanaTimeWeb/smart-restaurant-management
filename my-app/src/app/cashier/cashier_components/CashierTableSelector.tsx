...
// Supports Table Grid View & List View with status badges: Occupied ðŸ”´, Bill Requested ðŸŸ¡, Available ðŸŸ¢, Cleaning ðŸ§¹.
// DATA FLOW: cashier/page.tsx -> CashierTableSelector -> onSelect -> useCashierOrder
...
import type { CashierTableSelectorProps } from "@/app/cashier/cashier_types/CashierTypes";
...
export function CashierTableSelector({
  tables,
  selectedTableId,
  onSelect,
}: CashierTableSelectorProps): React.JSX.Element {
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-1">
                  ...
                  >
                    {isBillRequested ? "BILL REQ ðŸ§¾" : "OCCUPIED ðŸ”´"}
                  </span>
                </div>
