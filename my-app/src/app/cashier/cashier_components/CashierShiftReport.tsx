...
// DATA FLOW: useCashierShift → cashier/shift/page.tsx → CashierShiftReport → UI

import { Printer } from "lucide-react";
import { formatCurrency, formatDateTime } from "@/lib/formatters";
import type { CashierShiftReportProps } from "@/app/cashier/cashier_types/CashierTypes";
 ...
 */
export function CashierShiftReport({ shift, salesHistory }: CashierShiftReportProps) {
