...
// RESPONSIBILITY: Renders the payment method selection panel for the Cashier POS.
...
// DATA FLOW: CashierSplitPaymentPanel → onPaymentReady → cashier/page.tsx → checkout

import { useState, useEffect, useMemo } from "react";
import { Banknote, Smartphone, CreditCard } from "lucide-react";
import { formatCurrency } from "@/lib/formatters";
import type {
  CashierSplitPaymentPanelProps,
  CashierPaymentMode,
  CashierSingleMethod,
...
const PAYMENT_MODES: { value: CashierPaymentMode; label: string }[] = [
  { value: "SINGLE",        label: "Single Payment"  },
  { value: "SPLIT_BILL",    label: "Split Bill"       },
  { value: "SPLIT_PAYMENT", label: "Split Payment"    },
];

const SINGLE_METHODS: { value: CashierSingleMethod; label: string; icon: React.ReactNode }[] = [
 ...
 */
export function CashierSplitPaymentPanel({
  totalAmount,
  onPaymentReady,
}: CashierSplitPaymentPanelProps) {
  const [mode,         setMode]         = useState<CashierPaymentMode>("SINGLE");
