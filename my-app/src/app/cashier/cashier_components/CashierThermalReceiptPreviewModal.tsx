...
// RESPONSIBILITY: Live 80mm Thermal Paper Receipt Preview Modal for Cashier Cashier POS.
// Renders monospaced thermal print preview with restaurant branding, items breakdown, taxes, QR code, and print trigger.
// DATA FLOW: cartItems + taxBreakdown -> CashierThermalReceiptPreviewModal -> Thermal UI Preview / Window Print
...
export interface CashierThermalReceiptPreviewModalProps {
  isOpen: boolean;
  onClose: () => void;
  tableNumber: string;
...
export function CashierThermalReceiptPreviewModal({
  isOpen,
  onClose,
  tableNumber,
  cartItems,
...
}: CashierThermalReceiptPreviewModalProps): React.JSX.Element | null {
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-zinc-950 flex justify-center">
          <div className="w-full max-w-[280px] bg-white text-black font-mono p-4 rounded-md shadow-2xl text-xs space-y-2 border-dashed border-b-2 border-zinc-400">
            ...
            <div className="text-center pt-3 text-[10px] text-zinc-600 space-y-1 border-t border-dashed border-zinc-300">
              <p>Thank you for dining with us! ðŸ™</p>
