...
// Pure display component â€” no localStorage access, no calculations.
// DATA FLOW: useCashierOrder â†’ cashier/page.tsx â†’ CashierOrderSummary â†’ UI

import { Receipt } from "lucide-react";
import { formatCurrency } from "@/lib/formatters";
import type { CashierOrderSummaryProps } from "@/app/cashier/cashier_types/CashierTypes";
...
// â”€â”€â”€ Sub-component: Tax Row â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
interface TaxRowProps {
  ...
  amount:    number;
  isTotal?:  boolean;
  isCredit?: boolean; // discount / loyalty â€” shown in green
}
...
function TaxRow({ label, amount, isTotal = false, isCredit = false }: TaxRowProps) {
  ...
  return (
    ...
    >
      ...
      >
        {isCredit && amount > 0 ? "âˆ’" : ""}{formatCurrency(Math.abs(amount))}
      </span>
    </div>
  );
}
...
/**
 * Right panel â€” itemized bill table + tax breakdown + proceed button.
...
export function CashierOrderSummary({
  ...
  // â”€â”€ Empty state â€” no table selected â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      >
        Proceed to Payment â€” {formatCurrency(taxBreakdown.totalAmount)}
      </button>
    </div>
  );
}
