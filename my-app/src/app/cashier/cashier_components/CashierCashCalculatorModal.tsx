...
export interface CashierCashCalculatorModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function CashierCashCalculatorModal({
  isOpen,
  onClose,
  payableAmount,
  onConfirmPayment,
}: CashierCashCalculatorModalProps): React.JSX.Element | null {
