...
export interface CashierKeyboardShortcutsModalProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export function CashierKeyboardShortcutsModal({
  isOpen,
  onClose,
}: CashierKeyboardShortcutsModalProps): React.JSX.Element | null {
  useEffect(() => {
