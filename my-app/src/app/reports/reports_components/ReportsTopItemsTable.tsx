...
// DATA FLOW: useReports → reports/page.tsx → ReportsTopItemsTable

import { useState, useMemo } from "react";
import { Search, Filter } from "lucide-react";
import { formatCurrency } from "@/lib/formatters";
import { AppPagination } from "@/components/ui/AppPagination";
import type { ReportsTopItemsTableProps } from "@/app/reports/reports_types/ReportsTypes";
 ...
 *
 * @param topItems - Pre-sorted array of ReportsTopItem from useReports
 */
export function ReportsTopItemsTable({ topItems }: ReportsTopItemsTableProps) {
