...
// Includes inline KitchenRecipeEditor for recipe ingredient linking.
// Pessimistic submit button with Loader2 spinner.
// DATA FLOW: admin/menu/page.tsx → KitchenMenuFormModal → onSave(values) → useKitchenMenu
...
import { KitchenRecipeEditor } from "@/app/kitchen/kitchen_components/KitchenRecipeEditor";
import type { KitchenMenuFormModalProps, KitchenMenuFormValues } from "@/app/kitchen/kitchen_types/KitchenTypes";
 ...
 */
export function KitchenMenuFormModal({
  isOpen,
  editItem,
  inventoryItems,
  onSave,
  ...
  function onSubmit(values: KitchenMenuFormValues) {
    onSave(values);
    onClose();
  }
