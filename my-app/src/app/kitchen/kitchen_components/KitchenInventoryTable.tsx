...
// DATA FLOW: useKitchenInventory → admin/inventory/page.tsx → KitchenInventoryTable → UI
...
import type { KitchenInventoryTableProps } from "@/app/kitchen/kitchen_types/KitchenTypes";
 ...
 */
export function KitchenInventoryTable({ inventoryItems, onUpdateStock, onDelete, onUpdateExpiry }: KitchenInventoryTableProps) {
