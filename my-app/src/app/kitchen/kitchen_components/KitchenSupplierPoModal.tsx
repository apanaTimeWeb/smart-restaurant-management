...
// DATA FLOW: KitchenInventoryTable / inventory/page.tsx → KitchenSupplierPoModal → window.print()
...
interface KitchenSupplierPoModalProps {
  isOpen: boolean;
...
export function KitchenSupplierPoModal({
  isOpen,
  lowStockItems,
  onClose,
}: KitchenSupplierPoModalProps) {
