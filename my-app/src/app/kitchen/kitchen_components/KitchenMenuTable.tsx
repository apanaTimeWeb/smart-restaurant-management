...
// RESPONSIBILITY: Renders the menu items data table for the Kitchen Menu CRUD page.
...
// DATA FLOW: useKitchenMenu → admin/menu/page.tsx → KitchenMenuTable → UI
...
import type { KitchenMenuTableProps } from "@/app/kitchen/kitchen_types/KitchenTypes";
 ...
 */
export function KitchenMenuTable({
  menuItems,
  onEdit,
  onDelete,
  onToggleAvailability,
}: KitchenMenuTableProps) {
