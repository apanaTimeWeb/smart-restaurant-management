...
// RESPONSIBILITY: Online Advance Table Booking & Zero-Wait Pre-Ordering System (`/reservations/book`).
// Customer selects Date, Time, and Guest Count (e.g. 10 Persons).
// Calculates per-person deposit (10 x ₹100 = ₹1,000), collects payment via multi-gateway,
...
// DATA FLOW: reservations/book/page.tsx -> createAdvanceReservation() -> STORAGE_KEYS.ADVANCE_RESERVATIONS
...
const ADVANCE_RATE_PER_PERSON = 100 as const; // ₹100 per guest
      ...
      <div className="mx-auto max-w-4xl flex flex-col gap-6">
        ...
        {!currentUser && (
          <div className="rounded-3xl border border-border/80 bg-card p-8 shadow-xl flex flex-col items-center justify-center gap-6 max-w-md mx-auto w-full text-center mt-10">
            ...
            <Link 
              href={`/auth/login?redirect=${encodeURIComponent(`/reservations/book?tenant=${tenantIdParam}`)}`}
          ...
          <div className="rounded-3xl border border-border/80 bg-card p-6 shadow-xl flex flex-col gap-6">
            <div className="flex items-center justify-between border-b border-border/50 pb-3">
              ...
              <span className="rounded-full bg-emerald-500/10 border border-emerald-500/30 px-3 py-1 text-xs font-bold text-emerald-500">
                ₹{ADVANCE_RATE_PER_PERSON} / Guest Deposit
              </span>
            </div>
              ...
              <div>
                ...
                <p className="font-black text-2xl text-emerald-500">
                  ...
                  <span className="text-xs font-bold text-text-secondary">
                    ({guestCount} Persons × ₹{ADVANCE_RATE_PER_PERSON})
                  </span>
                </p>
