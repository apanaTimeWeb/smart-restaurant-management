...
// DATA FLOW: reservations/page.tsx → ReservationsFormModal → onSubmit → useReservations.addReservation
 ...
 */
export function ReservationsFormModal({
  isOpen,
  availableTables,
  isSubmitting,
  onSubmit,
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<ReservationsFormValues>({
  ...
  function handleFormSubmit(values: ReservationsFormValues): void {
    onSubmit(values);
    onClose();
  }
