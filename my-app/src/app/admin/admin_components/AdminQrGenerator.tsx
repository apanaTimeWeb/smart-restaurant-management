...
// DATA FLOW: admin/qr/page.tsx → AdminQrGenerator → canvas QR per AppTable

import { useEffect, useRef, useCallback } from "react";
import { Printer } from "lucide-react";
import type { AdminQrGeneratorProps } from "@/app/admin/admin_types/AdminTypes";
...
export function AdminQrGenerator({ tables, tenantId }: AdminQrGeneratorProps) {
