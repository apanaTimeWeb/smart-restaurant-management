...
// Includes inline AdminRecipeEditor for recipe ingredient linking.
// Pessimistic submit button with Loader2 spinner.
// DATA FLOW: admin/menu/page.tsx → AdminMenuFormModal → onSave(values) → useAdminMenu
...
import { AdminRecipeEditor } from "@/app/admin/admin_components/AdminRecipeEditor";
import type { AdminMenuFormModalProps, AdminMenuFormValues } from "@/app/admin/admin_types/AdminTypes";
 ...
 */
export function AdminMenuFormModal({
  isOpen,
  editItem,
  inventoryItems,
  onSave,
  ...
  function onSubmit(values: AdminMenuFormValues) {
    onSave(values);
    onClose();
  }
