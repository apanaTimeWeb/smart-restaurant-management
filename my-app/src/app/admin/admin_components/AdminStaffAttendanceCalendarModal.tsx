...
// Allows Admin to mark daily attendance (Present, Absent, Half Day) for selected staff member.
// Auto-calculates leave days and syncs directly into payroll salary calculations.
// DATA FLOW: AdminStaffTable → AdminStaffAttendanceCalendarModal → markAttendance → app_staff_attendance
...
interface AdminStaffAttendanceCalendarModalProps {
  isOpen: boolean;
  staff: AppUser | null;
...
export function AdminStaffAttendanceCalendarModal({
  isOpen,
  staff,
  attendanceRecords,
  onMarkAttendance,
  onClose,
}: AdminStaffAttendanceCalendarModalProps) {
