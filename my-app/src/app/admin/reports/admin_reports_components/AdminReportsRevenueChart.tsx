...
// DATA FLOW: useAdminReports → admin_reports/page.tsx → AdminReportsRevenueChart → ApexCharts → UI

import dynamic from "next/dynamic";
import type { AdminReportsRevenueChartProps } from "@/app/admin/reports/admin_reports_types/AdminReportsTypes";
 ...
 *
 * @param dailyRevenue - Array of 30 AdminReportsDailyStat entries from useAdminReports
 */
export function AdminReportsRevenueChart({ dailyRevenue }: AdminReportsRevenueChartProps) {
