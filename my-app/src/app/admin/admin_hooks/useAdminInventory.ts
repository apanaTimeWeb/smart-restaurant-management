...
// RESPONSIBILITY: All inventory management logic for the Admin module.
...
// DATA FLOW: localStorage → useLocalStorage → useAdminInventory
//            → AdminInventoryTable + admin/inventory/page.tsx

import { useMemo, useCallback } from "react";
import { useLocalStorage } from "@/hooks/useLocalStorage";
import { STORAGE_KEYS } from "@/lib/localStorageSeeder";
import type { AppInventoryItem } from "@/types/appTypes";
import type { UseAdminInventoryReturn } from "@/app/admin/admin_types/AdminTypes";
...
/**
 * Manages inventory stock levels for the Admin module.
 ...
 */
export function useAdminInventory(): UseAdminInventoryReturn {
