...
// RESPONSIBILITY: All shift management logic for the Admin module.
...
// No JSX — pure logic hook consumed by admin/shift/page.tsx.
// DATA FLOW: localStorage → useLocalStorage → useAdminShift → AdminShiftReport
//            + admin/shift/page.tsx

import { useState, useCallback, useMemo } from "react";
import { useLocalStorage } from "@/hooks/useLocalStorage";
import { STORAGE_KEYS } from "@/lib/localStorageSeeder";
import type { AppShiftRegister, AppSalesRecord } from "@/types/appTypes";
import type { UseAdminShiftReturn } from "@/app/admin/admin_types/AdminTypes";
...
/**
 * Manages shift open/close lifecycle for the Admin module.
 ...
 */
export function useAdminShift(): UseAdminShiftReturn {
