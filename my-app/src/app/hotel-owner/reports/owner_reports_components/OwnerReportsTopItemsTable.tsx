...
// DATA FLOW: useOwnerReports → owner_reports/page.tsx → OwnerReportsTopItemsTable

import { useState, useMemo } from "react";
import { Search, Filter } from "lucide-react";
import { formatCurrency } from "@/lib/formatters";
import { AppPagination } from "@/components/ui/AppPagination";
import type { OwnerReportsTopItemsTableProps } from "@/app/hotel-owner/reports/owner_reports_types/OwnerReportsTypes";
 ...
 *
 * @param topItems - Pre-sorted array of OwnerReportsTopItem from useOwnerReports
 */
export function OwnerReportsTopItemsTable({ topItems }: OwnerReportsTopItemsTableProps) {
