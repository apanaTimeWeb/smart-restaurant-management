...
// DATA FLOW: useOwnerReports → owner_reports/page.tsx → OwnerReportsRevenueChart → ApexCharts → UI

import dynamic from "next/dynamic";
import type { OwnerReportsRevenueChartProps } from "@/app/hotel-owner/reports/owner_reports_types/OwnerReportsTypes";
 ...
 *
 * @param dailyRevenue - Array of 30 OwnerReportsDailyStat entries from useOwnerReports
 */
export function OwnerReportsRevenueChart({ dailyRevenue }: OwnerReportsRevenueChartProps) {
