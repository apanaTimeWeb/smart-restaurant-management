...
// DATA FLOW: useOwnerShift → admin/shift/page.tsx → OwnerShiftReport → UI

import { Printer } from "lucide-react";
import { formatCurrency, formatDateTime } from "@/lib/formatters";
import type { OwnerShiftReportProps } from "@/app/hotel-owner/hotel-owner_types/OwnerTypes";
 ...
 */
export function OwnerShiftReport({ shift, salesHistory }: OwnerShiftReportProps) {
