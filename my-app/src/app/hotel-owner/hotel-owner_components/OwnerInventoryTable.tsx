...
// DATA FLOW: useOwnerInventory → admin/inventory/page.tsx → OwnerInventoryTable → UI
...
import type { OwnerInventoryTableProps } from "@/app/hotel-owner/hotel-owner_types/OwnerTypes";
 ...
 */
export function OwnerInventoryTable({ inventoryItems, onUpdateStock, onDelete, onUpdateExpiry }: OwnerInventoryTableProps) {
