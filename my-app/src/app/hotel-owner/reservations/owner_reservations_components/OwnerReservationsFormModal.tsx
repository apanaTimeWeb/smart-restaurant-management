...
// DATA FLOW: owner_reservations/page.tsx → OwnerReservationsFormModal → onSubmit → useOwnerReservations.addReservation
...
import type {
  OwnerReservationsFormModalProps,
  OwnerReservationsFormValues,
} from "@/app/hotel-owner/reservations/owner_reservations_types/OwnerReservationsTypes";
 ...
 */
export function OwnerReservationsFormModal({
  isOpen,
  availableTables,
  isSubmitting,
  onSubmit,
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<OwnerReservationsFormValues>({
  ...
  function handleFormSubmit(values: OwnerReservationsFormValues): void {
    onSubmit(values);
    onClose();
  }
