...
// DATA FLOW: localStorage → useLocalStorage → useOwnerShift → OwnerShiftReport
...
import type { UseOwnerShiftReturn } from "@/app/hotel-owner/hotel-owner_types/OwnerTypes";
...
/**
 * Manages shift open/close lifecycle for the Owner module.
 ...
 */
export function useOwnerShift(): UseOwnerShiftReturn {
