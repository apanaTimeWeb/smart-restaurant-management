...
// RESPONSIBILITY: All inventory management logic for the Owner module.
...
// DATA FLOW: localStorage → useLocalStorage → useOwnerInventory
//            → OwnerInventoryTable + admin/inventory/page.tsx

import { useMemo, useCallback } from "react";
import { useLocalStorage } from "@/hooks/useLocalStorage";
import { STORAGE_KEYS } from "@/lib/localStorageSeeder";
import type { AppInventoryItem } from "@/types/appTypes";
import type { UseOwnerInventoryReturn } from "@/app/hotel-owner/hotel-owner_types/OwnerTypes";
...
/**
 * Manages inventory stock levels for the Owner module.
 ...
 */
export function useOwnerInventory(): UseOwnerInventoryReturn {
