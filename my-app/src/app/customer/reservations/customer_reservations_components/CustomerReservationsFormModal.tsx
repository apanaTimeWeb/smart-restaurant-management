...
// DATA FLOW: customer_reservations/page.tsx → CustomerReservationsFormModal → onSubmit → useCustomerReservations.addReservation
...
import type {
  CustomerReservationsFormModalProps,
 ...
 */
export function CustomerReservationsFormModal({
  isOpen,
  availableTables,
  isSubmitting,
  onSubmit,
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<CustomerReservationsFormValues>({
  ...
  function handleFormSubmit(values: CustomerReservationsFormValues): void {
    onSubmit(values);
    onClose();
  }
