...
// RESPONSIBILITY: Online Advance Table Booking & Zero-Wait Pre-Ordering System (`/customer_reservations/book`).
...
// DATA FLOW: customer_reservations/book/page.tsx -> createAdvanceReservation() -> STORAGE_KEYS.ADVANCE_RESERVATIONS
      ...
      <div className="mx-auto max-w-4xl flex flex-col gap-6">
        ...
        {!currentUser && (
          <div className="rounded-3xl border border-border/80 bg-card p-8 shadow-xl flex flex-col items-center justify-center gap-6 max-w-md mx-auto w-full text-center mt-10">
            ...
            <Link 
              href={`/auth/login?redirect=${encodeURIComponent(`/customer_reservations/book?tenant=${tenantIdParam}`)}`}
