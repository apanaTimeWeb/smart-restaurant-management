...
// DATA FLOW: billing/page.tsx → BillingShiftSummaryBar → UI

import { DollarSign, QrCode, CreditCard, Lock, TrendingUp, Receipt } from "lucide-react";
import { formatCurrency } from "@/lib/formatters";
import type { BillingShiftMetrics } from "@/app/billing/billing_types/BillingTypes";

interface BillingShiftSummaryBarProps {
  metrics: BillingShiftMetrics;
  onOpenReconciliation: () => void;
}

export function BillingShiftSummaryBar({
  metrics,
  onOpenReconciliation,
}: BillingShiftSummaryBarProps) {
  return (
