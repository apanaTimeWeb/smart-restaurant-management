...
// DATA FLOW: waiter_reservations/page.tsx → WaiterReservationsFormModal → onSubmit → useWaiterReservations.addReservation
...
import type {
  WaiterReservationsFormModalProps,
 ...
 */
export function WaiterReservationsFormModal({
  isOpen,
  availableTables,
  isSubmitting,
  onSubmit,
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<WaiterReservationsFormValues>({
  ...
  function handleFormSubmit(values: WaiterReservationsFormValues): void {
    onSubmit(values);
    onClose();
  }
